...
class NetCat:
    ...
    def handle(self, client_socket):
        """[LISTENER] Handle the request from the sender and return a corresponding output."""
        # execute a command
        ...
        # receive a file and store it locally
            ...
            file_buffer = b''
            # read the contenst of the uploaded file iteratively
            while True:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent(
            ...
            netcay.py -t 192.168.1.108 -p 5555 -l -u=mytest.txt # upload to file
